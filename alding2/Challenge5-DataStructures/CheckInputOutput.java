//UIUC CS125 FALL 2013 MP. File: CheckInputOutput.java, CS125 Project: Challenge5-DataStructures, Version: 2013-10-14T13:45:00-0500.576972931
	...
	public static boolean checkAuthorship(String file, String ignoreDefault) {
			...
			while ((line = reader.readLine()) != null && !found) {
				...
				if (line.contains(ignoreDefault)) {
					System.err
							.println("File "
									+ file
									+ " : @author should include your netid");
					return false;
				}
				// else implied
		...
		if (!found)
			System.err
					.println("File "
							+ file
							+ " : @author line with your netid is missing.");
		return found;
	}
