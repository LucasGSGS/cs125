//UIUC CS125 FALL 2013 MP. File: CheckInputOutput.java, CS125 Project: Challenge6-RecursionSee, Version: 2013-11-05T16:03:10-0600.767323587
...
public class CheckInputOutput {
	 ...
	 * @param file ,
	 *            if the
	 * @author tag includes this value, it is presumed to be invalid
	 * @param ignoreDefault
	 * @return
	 */
	public static boolean checkAuthorship(String file, String ignoreDefault) {
		if (ignoreDefault == null)
			ignoreDefault = "@author replace-with-your-netid-here";
