//UIUC CS125 FALL 2013 MP. File: AutomaticScoreCheck.java, CS125 Project: Challenge2-Hollywood, Version: 2013-09-17T08:34:45-0500.110567916
...
/**
 * This program runs all three unit tests and generates a score.
...
public class AutomaticScoreCheck  {
	...
	public static void main(String[] args) throws Exception{
		...
		checkClassHasNoMutableStaticFields(FindScriptLine.class);
		checkClassHasNoMutableStaticFields(MyScriptPrinter.class);
		checkClassHasNoMutableStaticFields(MovieSurvey.class);

		TestRunner runner= new TestRunner();
		TestSuite suite = new TestSuite();
		suite.addTestSuite(FindScriptLineTest.class);
		suite.addTestSuite(MyScriptPrinterTest.class);
		suite.addTestSuite(MovieSurveyTest.class);
