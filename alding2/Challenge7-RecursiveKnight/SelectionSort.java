//UIUC CS125 FALL 2013 MP. File: SelectionSort.java, CS125 Project: Challenge7-RecursiveKnight, Version: 2013-11-12T09:02:55-0600.414969527
// @author alding2
public class SelectionSort {
	...
	public static int findMin(double[] data, int lo, int hi) {
		...
		return Math.min(data[lo],data[x]) == data[lo] ? lo : x;
	}
