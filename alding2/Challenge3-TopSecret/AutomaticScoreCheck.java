//UIUC CS125 FALL 2013 MP. File: AutomaticScoreCheck.java, CS125 Project: Challenge3-TopSecret, Version: 2013-09-21T10:44:19-0500.077173321
	...
	private static void checkClassHasNoMutableStaticFields(Class clss) {
		...
		for (int i = 0; i < fields.length; i++) {
			...
			if (Modifier.isStatic(m) && !Modifier.isFinal(m)) {
				System.out.println("Static varibles can only be used for constants in this MP - they must be declared with 'final' modified e.g. public static final int constant=42;");
				System.exit(1);
			}
		}
	...
	private static void checkFileForCompileError(File file) {
		...
		try {
			...
			if (sourceCode.contains("Unresolved compilation problem")) {
				System.out.println("Fix Compilation Errors in "
								+ file.getName()
			...
			if (sourceCode.contains("System.exit")) {
				System.out.println("Don't use System.exit (file: "+file.getName()+")- see README instructions");
				System.exit(1);
			}
			bis.close();
		} catch (Exception e) {
